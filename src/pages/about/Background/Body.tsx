      ...
      <h2 className="text-2xl font-bold border-b-[4px] border-[--bg-color] pb-3">About Us</h2>
        <p className="text-justify text-base leading-relaxed mb-1">
          Our journey began with modest beginnings in block molding, supported by a dedicated team of 15 individuals, two trucks, and a simple Portakabin office. It was a humble start, but one driven by a deep passion for construction and an unwavering commitment to quality.
           it is a client-focused and service-oriented General Engineering and Construction firm, was established in Enugu, Nigeria, in 2012.
             <br/>    
             <br/>
          Adeh Construction Company has evolved into a leading force in building and civil engineering construction. Our remarkable growth is a testament to our steadfast commitment to excellence and the expertise of our ever-expanding team of skilled engineers and supervisors.
        </p>
